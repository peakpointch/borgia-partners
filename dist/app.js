...
var _hscroll = require("borgia/hscroll");
var _animate = require("borgia/animate");
(0, _core.onReady)(()=>{
    console.log("WASSUUPPPP");
    (0, _hscroll.initCardsAndLinks)();
    (0, _animate.animateHeadings)();
    (0, _animate.initNavAnimation)();
});

},{"@xatom/core":"8w4K8","borgia/hscroll":"98y4r","borgia/animate":"cpnw6"}],"8w4K8":[function(require,module,exports,__globalThis) {
...
},{"./validate.js":"dfZI5","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"98y4r":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initCardsAndLinks", ()=>initCardsAndLinks);
var _index = require("../../node_modules/peakflow/dist/attributeselector/index");
var _gsap = require("gsap");
const scrollSelector = (0, _index.createAttribute)('data-hscroll-element');
function select(element) {
    const selector = scrollSelector(element);
    return element === 'section' ? document.querySelector(selector) : document.querySelector(scrollSelector('section')).querySelector(selector);
}
function selectAll(element) {
    const selector = scrollSelector(element);
    const selected = element === 'section' ? document.querySelectorAll(selector) : document.querySelector(scrollSelector('section')).querySelectorAll(selector);
    return Array.from(selected);
}
function initCardsAndLinks() {
    ...
    const observer = new IntersectionObserver((entries)=>{
        ...
        if (visibleCards.size === 0) // No cards are intersecting
        links.forEach((link)=>(0, _gsap.gsap).to(link, {
                opacity: 0.25,
                duration: 0.3,
                overwrite: 'auto'
            }));
            ...
            links.forEach((link, i)=>(0, _gsap.gsap).to(link, {
...
},{"../../node_modules/peakflow/dist/attributeselector/index":"8j6ig","gsap":"33IqQ","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"8j6ig":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"33IqQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"gljYa","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"cpnw6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "animateHeading", ()=>animateHeading);
parcelHelpers.export(exports, "animateHeadings", ()=>animateHeadings);
...
function animateHeading(element) {
    (0, _gsap.gsap).registerPlugin((0, _splitText.SplitText), (0, _scrollTrigger.ScrollTrigger));
    const heading = new (0, _splitText.SplitText)(element, {
        type: 'words',
        wordsClass: 'gsap-word'
    });
    (0, _gsap.gsap).from(heading.words, {
        y: 50,
        opacity: 0,
        duration: 0.6,
        ease: 'power3.out',
...
function animateHeadings() {
    const headings = document.querySelectorAll(animateSelector('heading'));
...
function navToLight(nav) {
    ...
    navComponents.forEach((component)=>{
        (0, _gsap.gsap).to(component, {
            color: "var(--_primitives---colors--white)",
            duration: 0.2,
            ease: "power2.out"
        });
        (0, _gsap.gsap).to(animateSelector('nav-brand'), {
            filter: "invert(100%)",
            color: "var(--_primitives---colors--white)",
            duration: 0.2,
            ease: "power2.out"
        });
        (0, _gsap.gsap).to(animateSelector('nav-link'), {
            color: "var(--_primitives---colors--white)",
            duration: 0.2,
            ease: "power2.out"
        });
        (0, _gsap.gsap).to(animateSelector('nav-button'), {
            color: "var(--_primitives---colors--white)",
...
function initNavAnimation() {
    ...
    lightSections.forEach((section)=>{
        (0, _scrollTrigger.ScrollTrigger).create({
            ...
            onLeave: ()=>{
                ...
                const stillInLight = lightSections.some((el)=>(0, _scrollTrigger.ScrollTrigger).isInViewport(el, 0));
    ...
    const anyVisible = Array.from(lightSections).some((el)=>(0, _scrollTrigger.ScrollTrigger).isInViewport(el, 0));
    if (anyVisible) {
        navToLight(navComponents);
        isLight = true;
    } else {
...
},{"../../node_modules/peakflow/dist/attributeselector/index":"8j6ig","gsap":"33IqQ","gsap/SplitText":"3sVmH","gsap/ScrollTrigger":"5ubnS","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"3sVmH":[function(require,module,exports,__globalThis) {
/*!
 * SplitText 3.13.0
 * https://gsap.com
 *
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"5ubnS":[function(require,module,exports,__globalThis) {
/*!
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}]},["jeTtx"], "jeTtx", "parcelRequirea14b", {})
